/**
 * Cloudflare Worker: R2 Cloud Editor (Image Preview Support)
 * * 🎨 UI: Sanyue ImgHub 风格 + 玻璃拟态
 * * 🖼️ 新增: 图片文件点击直接预览 (支持 jpg, png, gif, webp, svg 等)
...
const htmlParts = [
  ...
  '',
  '    /* --- 图片预览容器 --- */',
  '    #image-preview { display: none; flex: 1; justify-content: center; align-items: center; overflow: hidden; background: rgba(0,0,0,0.1); padding: 20px; }',
  ...
  '                 editorEl.style.display = "block"; imgContainer.style.display = "none";',
  '                 editorEl.value = "⚠️ 文件过大 (" + formatSize(info.size) + ")，无法预览。";',
  ...
  '                 editorEl.disabled = true; // 图片不能编辑文本',
  '                 ',
