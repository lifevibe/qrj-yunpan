...
const htmlParts = [
  ...
  '              <span class="warning-text" id="np-warning">⚠️ 此文件不支持在线预览或包含二进制内容</span>',
  '              <div style="display:flex; flex-direction:column; gap:10px; width:100%;">',
  '                    <button class="primary" id="np-download-btn" style="width:100%;">⬇ 下载文件</button>',
  '                    <button class="glass-btn" id="np-force-edit-btn" style="width:100%; font-size:12px; color:#aaa;">强行编辑 (文本)</button>',
  '              </div>',
  '          </div>',
  '      </div>',
  '',
  ...
  '           <button id="confirm-btn-ok" class="primary danger-btn" style="padding: 8px 30px; font-size:14px;">确认删除</button>',
  '       </div>',
  '    </div>',
  '  </div>',
  '',
